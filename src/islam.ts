...
class Islam {
  ...
  public Hisab(year: number, latitude: number = 6.075, longitude: number = 95.093, timezone: number = 7, altitude: number = 10) {
  ...
  public MasehiToHijri(
      ...
      dMonth: number,
      dDay: number,
      latitude: number = 6.075,
      longitude: number = 95.093,
      timezone: number = 7,
      altitude: number = 10,
  ) {
